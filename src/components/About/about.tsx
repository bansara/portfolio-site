...
const About: React.FC = () => { 
    const p: React.RefObject<HTMLParagraphElement> = useRef<HTMLParagraphElement>(null);
    const pSub: React.RefObject<HTMLParagraphElement> = useRef<HTMLParagraphElement>(null);
    useEffect(() => {
        window.scroll(0,0);
